...
export function ResearchSection({
  ...
  return (
    <Reveal as="section" id="research" className="scroll-mt-16 pb-2 pt-[104px]">
      <SectionHeader index="05" label="RESEARCH" />
      ...
      <ol className="m-0 flex list-none flex-col border-b border-line p-0">
        {shown.map((paper, index) => (
          ...
          >
            ...
            {/*
              Only rendered when there is something to open. The single paper
              here is in preparation, so this button is absent rather than
              pointing at "#".
            */}
            {paper.url ? (
              <a
