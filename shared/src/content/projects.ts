...
export const projects: Project[] = [
  {
    ...
    description:
      "A multi-tenant agentic RAG platform that answers questions over private document corpora with machine-checkable citations. A tool-driven LLM planner, with nine capabilities including hybrid corpus search, web search and full-page crawl, runs over hybrid retrieval, dense vector search in Qdrant fused with Postgres full-text, behind PostgreSQL row-level security for tenant isolation, with per-passage redaction and full audit logging. It ships a real-time streaming workspace covering chat, notes, spreadsheets and multi-section research reports, with an OpenAPI-generated typed client, OpenTelemetry observability and CI-gated migrations.",
    highlights: [
      ...
      "Delivered egress-safe web research, an SSRF-guarded crawler with passage redaction before model egress, plus a multi-section cited research-report generator",
